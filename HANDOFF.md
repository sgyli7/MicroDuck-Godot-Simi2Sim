...
> **当前续轮：联合行走/加速**。会话 `results/sprint_joint_20260912/`，两小时上限、最后30分钟收尾，新开发种子921000–921007、新最终种子922000–922029。先修正上述边界诊断，再对照普通/加速共用 actor 的速度条件训练；当前见[续轮协议](docs/sprint_joint_20260912/PROTOCOL.md)。未修改冻结游戏物理、默认模型或旧最终集。恢复时先查账本与活进程，不重复启动。
